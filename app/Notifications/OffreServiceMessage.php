...
class OffreServiceMessage extends Notification
{
    use Queueable;
     ...
     * @return void
     */
    public function __construct($offreService, $message, $email)
    {
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
                    ...
                    ->line($this->message)
                    ->line('--------------------------------------')
                    ->action('Voir votre annonce', route('offres.show',$this->offreService->id))
