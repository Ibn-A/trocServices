        ...
        <div class="row">
            ...
            <div class="col-12 col-md-9 col-lg-9">
                <svg xmlns:svg="http://www.w3.org/2000/svg" viewBox="0 0 900 900">
                    ...
                    <a href="{{route('offres.index', 'pays_de_la_loire')}}">
                    ...
                    <a href="{{route('offres.index', 'bretagne')}}">
                    ...
                    <a href="{{route('offres.index', 'centre')}}">
                    ...
                    <a href="{{route('offres.index', 'normandie')}}">
                    ...
                    <a href="{{route('offres.index', 'ile_de_france')}}">
                    ...
                    <a href="{{route('offres.index', 'hauts_de_france')}}">
                    ...
                    <a href="{{route('offres.index', 'grand_est')}}">
                    ...
                    <a href="{{route('offres.index', 'bourgogne')}}">
                    ...
                    <a href="{{route('offres.index', 'auvergne')}}">
                    ...
                    <a href="{{route('offres.index', 'provence')}}">
                    ...
                    <a href="{{route('offres.index', 'corse')}}">
                    ...
                    <a href="{{route('offres.index', 'aquitaine')}}">
