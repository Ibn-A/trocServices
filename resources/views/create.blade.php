                ...
                <div class="form-group">
                    ...
                    <select class="custom-select" name="service" id="service">
                        @foreach ($services as $service)
                            <option value="{{ $service->id }}" @if($loop->first) selected @endif>{{ $service->nomService }}</option>
                        @endforeach
                    </select>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="custom-select" name="region" id="region">
                                @foreach ($localisations as $localisation)
                                    <option data-code="{{ $localisation->code }}" value="{{ $localisation->id }}" @if($loop->first) selected @endif>{{ $localisation->name }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
