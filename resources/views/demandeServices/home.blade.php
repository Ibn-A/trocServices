        ...
        <div class="row">
            ...
            <div class="col-12 col-md-9 col-lg-9">
                <svg xmlns:svg="http://www.w3.org/2000/svg" viewBox="0 0 900 900">
                    <a href="{{route('demandes.index', 'Occitanie')}}">
                    ...
                    <a href="{{route('demandes.index', 'Pays_de_la_loire')}}">
                    ...
                    <a href="{{route('demandes.index', 'Bretagne')}}">
                    ...
                    <a href="{{route('demandes.index', 'Centre')}}">
                    ...
                    <a href="{{route('demandes.index', 'Normandie')}}">
                    ...
                    <a href="{{route('demandes.index', 'Ile_de_france')}}">
                    ...
                    <a href="{{route('demandes.index', 'Hauts_de_france')}}">
                    ...
                    <a href="{{route('demandes.index', 'Grand_est')}}">
                    ...
                    <a href="{{route('demandes.index', 'Bourgogne')}}">
                    ...
                    <a href="{{route('demandes.index', 'Auvergne')}}">
                    ...
                    <a href="{{route('demandes.index', 'Provence')}}">
                    ...
                    <a href="{{route('demandes.index', 'Corse')}}">
                    ...
                    <a href="{{route('demandes.index', 'Aquitaine')}}">
